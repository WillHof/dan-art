    ...
    render(){
        return(           
            <ul className="navbar-nav mr-auto mt-2 mt-lg-0">
                <li className={window.location.pathname.includes("Paintings") |window.location.pathname.includes("Drawings")|window.location.pathname.includes("Installation") ? "nav-item dropdown-toggler active" : "nav-item dropdown-toggler"}>
                    <span className="nav-link dropdown-toggle" id="navbarDropdown" type="button" data-toggle="collapse" data-target="#dropmenu" aria-haspopup="true" aria-expanded="false">WORK</span> 
